...
import org.uma.jmetal.algorithm.multiobjective.cellde.MyCellDE45;
 ...
 */
public class DCellDERunner extends AbstractAlgorithmRunner {
  /**
   ...
   */
  public static void MyDCellDE(String[] args) throws JMetalException, IOException {
    int i = 30;
    while (i-- > 0) {
...
//      referenceParetoFront = "jmetal-problem/src/test/resources/pareto_fronts/DTLZ1.3D.pf" ;
      ...
      crossover = crossover = new DifferentialEvolutionCrossover(cr, f, "rand/1/bin");

      selection = new BinaryTournamentSelection<DoubleSolution>(new RankingAndCrowdingDistanceComparator<DoubleSolution>());

      algorithm = new MyCellDE45(
              problem,
              50000,
              100,
      ...
      if (!referenceParetoFront.equals("")) {
        OwnAlgorithmRunner.printQualityIndicators(population, referenceParetoFront,"DCellDE") ;
      }
    }
  }
}
