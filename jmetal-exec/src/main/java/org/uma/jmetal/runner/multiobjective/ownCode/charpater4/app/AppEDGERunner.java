package org.uma.jmetal.runner.multiobjective.ownCode.charpater4.app;
...
import org.uma.jmetal.runner.multiobjective.ownCode.OwnProblem.Capater5.QosAPP;
 ...
 */
public class AppEDGERunner extends AbstractAlgorithmRunner {
  /**
...
//      OwnAlgorithmRunner.setNum(30);
      ...
      if (args.length == 1) {
        ...
        problemName = "org.uma.jmetal.runner.multiobjective.ownCode.OwnProblem.Capater4.QoSApp";
//        referenceParetoFront = "jmetal-problem/src/test/resources/pareto_fronts/ZDT1.pf";
      ...
      DataSheetAlgorithmRunner.printFinalSolutionSet(population,"EGDE3","APP", ""+ QoSApp.getAmount());
    }
