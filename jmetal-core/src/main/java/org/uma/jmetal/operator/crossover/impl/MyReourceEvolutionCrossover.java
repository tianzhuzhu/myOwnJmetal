...
public class MyReourceEvolutionCrossover extends MyDifferentialEvolutionCrossover {
  private static double r=0.5;
  private double possible1=1;
  private double possible2=1;
  ...
  /** Constructor */
  public MyReourceEvolutionCrossover() {
   ...
   * @param variant
   */
  public MyReourceEvolutionCrossover(double cr, double f, String variant) {
    this(
        cr,
        f,
        variant,
  ...
  /** Constructor */
  public MyReourceEvolutionCrossover(double cr, double f, double k, String variant) {
    this(cr, f, variant);
    this.k = k;
  }
  ...
  public static void setR(double r) {
    MyReourceEvolutionCrossover.r = r;
  }
  ...
  public List<DoubleSolution> execute(List<DoubleSolution> parentSolutions) {
    ...
    DoubleSolution best =parentSolutions.remove(0);
    int jrand;
    child = (DoubleSolution) currentSolution.copy();
    DoubleSolution child1 = (DoubleSolution) currentSolution.copy();
    DoubleSolution child2 = (DoubleSolution) currentSolution.copy();
    DoubleSolution child3 = (DoubleSolution) currentSolution.copy();
    ...
    Double r1 = crRandomGenerator.getRandomValue(0.0, 1.0);
    Double r2 = crRandomGenerator.getRandomValue(0.0, 1.0);
        ...
        if (crRandomGenerator.getRandomValue(0.0, 1.0) < cr || j == jrand) {
          ...
          value =
                  currentSolution.getVariable(j)
                          ...
                          * (parentSolutions.get(0).getVariable(j)
                          - parentSolutions.get(1).getVariable(j))
                          +k*(best.getVariable(j)-currentSolution.getVariable(j));

          value = solutionRepair.repairSolutionVariableValue(value, child.getLowerBound(j), child.getUpperBound(j));
          child2.setVariable(j, value);
    ...
    List a =new ArrayList();
      ...
      a.add(child2);
      a.add(child3);
    child=Collections.min(a, new DominanceComparator<DoubleSolution>());
