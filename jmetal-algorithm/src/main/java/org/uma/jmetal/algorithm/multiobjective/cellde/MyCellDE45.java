...
public class MyCellDE45 implements Algorithm<List<DoubleSolution>> {
  ...
  public MyCellDE45(Problem<DoubleSolution> problem,
                    int maxEvaluations,
                    int populationSize,
  ...
  public void run() {
    ...
    while (!isStoppingConditionReached()) {
      iter++;
      double exp = Math.exp(2 * iter);
      this.feedback=populationSize*0.3*iter+0.05;
