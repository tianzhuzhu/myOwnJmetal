...
public class Preference<S>  {
  ...
  /** Constructor */
  public Preference(Ranking<S> ranking, DensityEstimator<S> densityEstimator, Preference<S> relatedPreference) {
  ...
  /**
   * Recomputes the ranking and density estimators on a solution list if they are different of the ones of the
   * related preference.
   */
